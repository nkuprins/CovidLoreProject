...
CREATE TABLE `comment_scores` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `comment_votes_ibfk_1` FOREIGN KEY (`comment_id`) REFERENCES `comments` (`comment_id`),
  CONSTRAINT `comment_votes_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
-- Dump completed on 2022-05-14 15:22:57
